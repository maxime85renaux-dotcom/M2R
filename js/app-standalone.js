...
/* ══ i18n inline — FR/EN selon lang de la page ══ */
(function() {
  ...
  const translations = {
    fr: {
      ...
      'lbl.accomplir':           'À accomplir',
      'lbl.chronometree':        'Chronométrée',
    ...
    en: {
      ...
      'lbl.processus':           'Walkthrough',
      'lbl.processus.complet':   'Full walkthrough',
      'lbl.type':                'Type',
      'lbl.niveau':              'Level',
      'lbl.mission':             'Mission',
      'lbl.detail.mission':      'Mission detail',
      'lbl.obtention':           'How to obtain',
      'lbl.accomplir':           'To complete',
      'lbl.chronometree':        'Timed',
...
function initSaviez() {
  ...
  const factsEN = [
    "The biologist needs 2 hours to study one item.",
    "There is no level restriction to change your gender or kingdom.",
    ...
    "Item-Shop items are tradeable and sellable in-game.",
    ...
    "Buff skills are active on all members of your group.",
    "There is no level restriction to talk in general chat.",
    "You can chain riding quests without your horse needing rest.",
    "An offline shop lasts 30 days.",
    "On M2Return, all kingdoms speak the same language.",
    "The blacksmith has more experience on weapons and armors of level 20 and below.",
    "The biologist success rate is ~50% — expect ~20 days for the first one.",
    "Thaloria is the first M2Return server.",
  ];
...
const QUESTS_DATA_EN = [{"niv":1,"nom":"Bienvenue sur metin","pnj":"Automatic","recompenses":"300 EXP · 200 Yang · 4× Red Potion (s) · Wooden Jewelry +0","processus":["Go see the Village Guard","Go see the Village Guardian","Go see the Merchant Lady to collect the Red Potions (s)","Return to Village Guardian"]},{"niv":2,"nom":"Lettre du Garde du Village","pnj":"Automatic","recompenses":"550 EXP · 1.000 Yang · 15× Red Potion (s)","processus":["Go see the Village Guard","Kill 9 Chiens errants","Return to Village Guard"]},{"niv":3,"nom":"Aidez la Marchande","pnj":"Automatic","recompenses":"850 EXP · 5.000 Yang · 20× Blue Potion (s)","processus":["Talk to the Village Guard","Go see the Merchant Lady","Bring the livre to the Armor Shop"]},{"niv":4,"nom":"Un nouvel arôme","pnj":"Merchant Lady","recompenses":"1.000 EXP · 500 Yang","processus":["Go see the Merchant Lady","Go see the Weapons Shop","Collect 2 Lilas sur the Loups bleus","Return to Weapons Shop","Achetez de the Huile de Musc dans the item-shop","Return to Merchant Lady"]},{"niv":5,"nom":"L'apprentissage","pnj":"Automatic","recompenses":"4 points de compétences","processus":["Go see votre Class Master","Choose your specialization — this choice is permanent"]},{"niv":6,"nom":"La mission du Forgeron","pnj":"Automatic","recompenses":"5.000 EXP · 1.500 Yang · Wolf Fur+","processus":["Go see the Village Guard","Go see the Blacksmith","Go see the Storekeeper","Return to Blacksmith"]},{"niv":6,"nom":"La Marchande","pnj":"Merchant Lady","recompenses":"1.500 EXP · 1.000 Yang","processus":["Go see the Merchant Lady","Go see Yonah the potier","Collect a Noyau de Pêche sur the Sangliers","Return to Yonah","Return to Merchant Lady"]},{"niv":7,"nom":"Le dîner","pnj":"Merchant Lady","recompenses":"1.000 EXP · 1.500 Yang","processus":["Go see the Merchant Lady","Go see the Armor Shop pour savoir ce qu'il veut manger","Return to Merchant Lady and tell him ce que son père veut manger : ragoût épicé avec of the gibier d'ours, a chou aromatique and deux œufs"]},{"niv":7,"nom":"Encore une autre faveur","pnj":"Automatic","recompenses":"1.500 EXP · 5.000 Yang","processus":["Go see the Blacksmith","Find the Fisherman and deliver the fishing rod to him","Return the money to the Blacksmith"]},{"niv":7,"nom":"Le mariage de la fille","pnj":"Octavio","recompenses":"4.000 EXP · 5.000 Yang · Arme 0 à 20+3 selon the classe","processus":["Go see Octavio","Go see the Old Woman","Collect a Bloodred Flower sur the Loups alphas affamés","Collect a Orange Flower sur the Loups bleus affamés","Collect a Yellow Perfumed Flower sur the Loups alphas bleus affamés","Return to Old Woman avec the fleurs to get the Noble Bouquet","Bring the Noble Bouquet à the sœur de the Old Woman dans the village voisin","Return to Octavio"]},{"niv":8,"nom":"Ingrédients pour le médicament","pnj":"Baek-Go","recompenses":"3.000 EXP · 5.000 Yang · Fourrure de loup","processus":["Go see Baek-Go","Collect a Wolf Liver sur the Loups bleus","Return to Baek-Go"]},{"niv":9,"nom":"Une lettre du Forgeron","pnj":"Blacksmith","recompenses":"4.000 EXP · 3.000 Yang","processus":["Talk to the Blacksmith","Portez the Blacksmith's Letter to Deokbae, the bûcheron of the village voisin","Return to Blacksmith"]},{"niv":9,"nom":"Parlez au Garde du Village","pnj":"Automatic","recompenses":"9.500 EXP · 2.000 Yang","processus":["Talk to the Village Guard"]},{"niv":9,"nom":"Packs","pnj":"Automatic","recompenses":"Aucune","processus":["Read the quête"]},{"niv":10,"nom":"Allez voir le capitaine","pnj":"Automatic","recompenses":"9.500 EXP · 2.000 Yang","processus":["Go see the Captain","Find Yu-Hwan the musicien dans the village voisin","Return to Captain"]},{"niv":10,"nom":"Trouvez Soon","pnj":"Aranyo","recompenses":"7.000 EXP · 10.000 Yang","processus":["Go see Aranyo","Go see Soon","Return to talk to Aranyo and tell him où se trouve son mari"]},{"niv":10,"nom":"Aidez Soon","pnj":"Soon","recompenses":"6.000 EXP · 2.000 Yang","processus":["Talk to Soon","Talk to Uriel","Return to Soon avec the classement : oiseau céleste, trois plis, eau, aile de grue"]},{"niv":11,"nom":"La commande d'armure","pnj":"Armor Shop","recompenses":"26.000 EXP · 15.000 Yang · Snout","processus":["Talk to the Armor Shop","Find the Blacksmith","Talk to Uriel — tuez Chiens errants to get the Uriel's Book, apportez-le to Uriel to get the iron ore","Talk to Octavio — tuez Ours to get a Bile, apportez-la pour the copper ore","Talk to Yonah — tuez Sangliers rouges pour the Clay, apportez-la pour the charcoal","Return to talk to the Blacksmith avec the 3 minerais","Allez annoncer the nouvelle to the Armor Shop"]},{"niv":12,"nom":"Allez parler au Capitaine","pnj":"Automatic","recompenses":"24.000 EXP · 3.500 Yang","processus":["Go see the Captain","Kill 10 Loups alphas gris","Return to talk to the Captain"]},{"niv":12,"nom":"Le meilleur livre de cuisine","pnj":"Octavio","recompenses":"12.000 EXP · 5.000 Yang · Wolf Claw","processus":["Go talk to Octavio","Go see Soon","Return to talk to Octavio","Kill Loups gris until you get a Wolf Intestine","Return to Octavio"]},{"niv":13,"nom":"Trouvez une fourrure de loup","pnj":"Old Woman","recompenses":"15.000 EXP · Armure niveau 9 selon the classe","processus":["Talk to the Old Woman","Kill Loups gris until you get a Fourrure de loup (quête)","Return to talk to the Old Woman"]},{"niv":14,"nom":"Détruisez les pierres metin","pnj":"Automatic","recompenses":"48.000 EXP · 10.000 Yang · Spirit Stone","processus":["Go talk to the Captain","Destroy a War Metin","Return to Captain"]},{"niv":15,"nom":"Trouvez Yu-Hwan le musicien","pnj":"Automatic","recompenses":"45.000 EXP · 2.000 Yang","processus":["Go talk to the Captain","Find Yu-Hwan dans the village voisin","Return to talk to the Captain"]},{"niv":15,"nom":"Le gâteau de riz","pnj":"Ah-Yu","recompenses":"26.000 EXP · 10.000 Yang","processus":["Talk to Ah-Yu","Go see the Weapons Shop","Go talk to Octavio","Find Yu-Rang dans the village voisin","Go see Taurean","Return to Yu-Rang in order to récupérer the gâteau de riz","Bring it to Ah-Yu"]},{"niv":16,"nom":"Capturez l'espion","pnj":"Automatic","recompenses":"100.000 EXP · 5.000 Yang","processus":["Talk to the Captain","Kill Soldats of the Serment Blanc and Archers of the Serment Blanc until you get the Letter","Return to Captain"]},{"niv":16,"nom":"Trouvez la hache d'or","pnj":"Blacksmith","recompenses":"36.000 EXP · 10.000 Yang · Ornament","processus":["Talk to the Blacksmith","Kill Soldats of the Serment Blanc until you get the Hache d'Or","Bring it to the Blacksmith"]},{"niv":17,"nom":"Le cadeau pour Chaegirab","pnj":"Wonda-Rim","recompenses":"40.000 EXP · 10.000 Yang · Skill Book OR 20.000 EXP · 20.000 Yang · Gold Nugget","processus":["Go talk to Wonda-Rim","Go see Uriel pour a idée de cadeau","Return to Wonda-Rim pour lui faire part de the idée d'Uriel","Kill Mu-Rang until you get 5 Fourrures de Mu-Rang","Bring the fourrures to Wonda-Rim","Portez the cadeau to Chaegirab (he will refuse)","Return to Wonda-Rim pour lui expliquer the situation","Bring the fourrure to Yang-Shin dans the village voisin"]},{"niv":18,"nom":"Trouvez l'épingle à cheveux","pnj":"Merchant Lady","recompenses":"60.000 EXP · 10.000 Yang · Riding Ticket","processus":["Go see the Merchant Lady","Talk to the Blacksmith","Talk to the Weapons Shop","Kill Archers of the Serment Blanc until you get the épingle volée","Bring the épingle to the Merchant Lady"]},{"niv":19,"nom":"Trouvez mon frère","pnj":"Mirine","recompenses":"122.000 EXP · 5.000 Yang","processus":["Talk to Mirine","Search for informations auprès de Yu-Hwan the musicien of the village voisin","Go see Yang-Shin","Bring the informations to Mirine"]},{"niv":20,"nom":"Tuez Mi-Jung du serment blanc","pnj":"Village Guardian","recompenses":"122.000 EXP · 20.000 Yang · Silver Bracelet","processus":["Talk to the Village Guardian","Allez tuer Mi-Jung","Return to Village Guardian"]},{"niv":21,"nom":"Cherchez les matériaux","pnj":"Weapons Shop","recompenses":"122.000 EXP · 20.000 Yang · Arme 20+3 selon the classe","processus":["Talk to the Weapons Shop","Go see Uriel — tuez Tigres to get the Uriel's Package, retournez voir Uriel pour the iron ore","Go see Ariyoung dans the village voisin","Bring the lettre d'Ariyoung to Ah-Yu","Return to Weapons Shop"]},{"niv":22,"nom":"Le gardien malade","pnj":"Automatic","recompenses":"50.000 EXP · 12.000 Yang · Gold Thread Shoes +4 · 5× Potion Violette (g)","processus":["Talk to the Village Guardian","Go see Baek-Go","Kill Tigres blancs until you get Medicinal Herbs+","Kill Tigres until you get a Tiger Liver+","Bring the ingrédients to Baek-Go","Bring the remède au Tower Guard's brother at the back of Hwang Temple in less than 20 minutes"]},{"niv":23,"nom":"Tuez Eun-Jung du serment blanc","pnj":"Village Guardian","recompenses":"150.000 EXP · 25.000 Yang · Gold Necklace +4","processus":["Talk to the Village Guardian","Kill Eun-Jung","Return to Village Guardian"]},{"niv":25,"nom":"La cavalerie lourde","pnj":"Captain","recompenses":"150.000 EXP · 30.000 Yang · Gold Earrings","processus":["Talk to the Captain","Talk to Yu-Hwan","Talk to the Traveling Merchant","Talk to Uriel","Return to Captain"]},{"niv":25,"nom":"Vaincre les Jin-Hees","pnj":"Old Woman","recompenses":"Couple Ring","processus":["Talk to the Old Woman","Kill 10 Jin-Hees","Return to Old Woman"]},{"niv":26,"nom":"Le déserteur","pnj":"Yang-Shin","recompenses":"35.000 EXP · 17.500–35.000 Yang · Rose jaune","processus":["Talk to Yang-Shin","Talk to Nakajima","Talk to Ah-Yu","Return to talk to Yang-Shin"]},{"niv":27,"nom":"Tuer les Goo-Paes","pnj":"Ariyoung","recompenses":"300.000 EXP · 10.000 Yang","processus":["Talk to Ariyoung","Talk to the Merchant Lady","Return to talk to Ariyoung","Kill Goo-Pae until you get the Ariyoung's Alliance","Return to Ariyoung"]},{"niv":27,"nom":"Détruisez la metin noire","pnj":"Captain","recompenses":"1.000.000 EXP · 15.000 Yang · Red Ribbon Mat · Ornament","processus":["Talk to the Captain","Destroy a Black Metin","Return to Captain"]},{"niv":28,"nom":"Le soucis d'Ah-Yu","pnj":"Ah-Yu","recompenses":"850.000 EXP OR 500.000 EXP + 40.000 Yang","processus":["Talk to Yu-Hwan","Talk to Ah-Yu","Kill Bera to get a Patte d'Ours","Bring the Patte d'Ours to Yang-Shin","Talk to Ah-Yu"]},{"niv":29,"nom":"La porcelaine brisée","pnj":"Yonah","recompenses":"600.000 EXP · 38.000 Yang","processus":["Talk to Yonah","Talk to Taurean","Talk to Harang","Talk to the Stablehand","Obtain 6 Hay sur the Barbarian Soldiers ou Forts Barbarian Soldiers (ou achetez-les à a joueur)","Bring the Hay to Yonah"]},{"niv":30,"nom":"Les Lances","pnj":"Ah-Yu","recompenses":"300.000 EXP · 20.000 Yang","processus":["Talk to Ah-Yu","Kill Barbarian Archers, Barbarian Minions, Barbarian Soldiers and Barbarian Generals until you get the 3 Lances of the mari","Talk to Ah-Yu"]},{"niv":30,"nom":"Le secret des Pierres Metin","pnj":"Uriel","recompenses":"1.500.000 EXP · 20.000 Yang","processus":["Talk to Uriel","Go to the Hasun Monument in the Monkey Dungeon (Hasung Dong)","Talk to Uriel","Go to the Seul Rong Monument dans the Vallée de Seungryong","Talk to Uriel"]},{"niv":31,"nom":"Ramenez les fleurs","pnj":"Huahn-So","recompenses":"400.000 EXP · 12.000 Yang","processus":["Talk to Huahn-So","Talk to Ariyoung","Talk to Huahn-So","Search for the Rare Flower dans the Nameless Flowers","Talk to Huahn-So"]},{"niv":32,"nom":"Les pages du livre secret 1","pnj":"Uriel","recompenses":"1.250.000 EXP · 50.000 Yang · Goddess Tear","processus":["Talk to Uriel","Talk to the Traveling Merchant","Ramenez-lui 20 Épées en argent (en vente to the Weapons Shop)","Obtain the Diary Page sur the Monument of Weol","Bring it to Uriel"]},{"niv":32,"nom":"Les pages du livre secret 2","pnj":"Uriel","recompenses":"1.250.000 EXP · 50.000 Yang · 10× Drapeau blanc","processus":["Talk to Uriel","Talk to Yang-Shin","Kill Sorciers orcs élites until you get the Diary Page","Bring it to Uriel"]},{"niv":33,"nom":"La nouvelle arme","pnj":"Blacksmith","recompenses":"200.000 EXP · 20.000 Yang · Arme 25+3 selon the classe","processus":["Talk to the Blacksmith","Mine 100 Gold Ores · 100 Silver Ores · 100 Ebony Ores","Return to Blacksmith"]},{"niv":34,"nom":"La nouvelle armure","pnj":"Blacksmith","recompenses":"200.000 EXP · 20.000 Yang · Armure 26+3 selon the classe","processus":["Talk to the Blacksmith","Mine 100 Ebony Ores · 100 Copper Ores · 100 Pearl Fragments","Return to Blacksmith"]},{"niv":35,"nom":"La hache de Deokbae","pnj":"Deokbae","recompenses":"400.000 EXP · 30.000 Yang","processus":["Talk to Deokbae","Kill Généraux barbares until you get the Golden Axe de David Kim","Bring it back to Deokbae"]},{"niv":36,"nom":"Le frère disparu","pnj":"Mirine","recompenses":"600.000 EXP · 35.000 Yang","processus":["Talk to Mirine","Talk to Yu-Hwan","Talk to Yang-Shin","Search for the Cultivateur de Ginseng","Bring the Mirine's Pendant and the Collier de jade +2 to Mirine"]},{"niv":37,"nom":"L'araignée à clochette","pnj":"Yu-Rang","recompenses":"700.000 EXP · 30.000 Yang","processus":["Talk to Yu-Rang","Search for the clochette sur the Jeunes araignées","Talk to Taurean","Kill Jeunes araignées pour accrocher the clochette","Talk to Yu-Rang","Talk to Taurean"]},{"niv":38,"nom":"Le Livre du Temple","pnj":"Soon","recompenses":"850.000 EXP · 20.000 Yang","processus":["Talk to Soon","Talk to Aranyo","Talk to the Merchant Lady","Talk to Soon","Kill Deadly Fanatics until you get the Livre of the Temple Secret","Return to Soon"]},{"niv":39,"nom":"Le Gâteau de riz perdu","pnj":"Yu-Rang","recompenses":"900.000 EXP · 25.000 Yang","processus":["Talk to Yu-Rang","Vous avez 30 minutes to get the Gâteau de riz sur the Jeunes araignées","Return to Yu-Rang — if time has run out, the quest ends with no reward"]},{"niv":40,"nom":"Les pages du livre secret 3","pnj":"Uriel","recompenses":"2.000.000 EXP · 50.000 Yang · Life Blessing","processus":["Talk to Uriel","Kill Proud Deadly Fanatics until you get the Diary Page","Bring it to Uriel"]},{"niv":40,"nom":"Les pages du livre secret 4","pnj":"Uriel","recompenses":"2.750.000 EXP · 50.000 Yang · Magic Blessing","processus":["Talk to Uriel","Go to the Monument Wha then the Monument Su dans the Jungsun Dong","Return to Uriel"]},{"niv":40,"nom":"Les pages du livre secret 5","pnj":"Uriel","recompenses":"750.000 EXP + 2.000.000 EXP (at level 47) · 50.000 Yang · Magic Blessing","processus":["Talk to Uriel","Talk to the Captain","Talk to Nakajima","Kill the Captain bestial until you get the Diary Page","Return to Uriel a fois the niveau 47 atteint"]},{"niv":40,"nom":"Tuez les Généraux du vent noir","pnj":"Captain","recompenses":"1.000.000 EXP · Language Ring (30 jours)","processus":["Talk to the Captain","Kill once: the Jak-To of the Vent Noir, the To-Su of the Vent Noir and the Gu-Ryung of the Vent Noir","Return to talk to the Captain"]},{"niv":41,"nom":"La demande du Marchand","pnj":"Traveling Merchant","recompenses":"1.100.000 EXP · Gold Necklace · Gold Bracelet · Gold Earrings","processus":["Go see the Traveling Merchant","Go see Ariyoung qui vous donne Clothes à rendre to Ah-Yu — retournez voir Ariyoung to get the Thread","Go see the Merchant Lady — tuez Tigres and Tigres blancs pour Medicinal Herbs + 100 Foies de tigre, échangez contre the Jewelry Piece","Kill Sorciers orcs élites until you get 100 Unggyi Teeth","Bring the Thread, the Jewelry Piece and the Unggyi Teeth to the Traveling Merchant"]},{"niv":42,"nom":"Grouic Grouic","pnj":"Octavio","recompenses":"600.000 EXP · 500.000 Yang · 3× Carpe amour grillé","processus":["Talk to Octavio","Talk to the Fisherman then to Yonah then to the Blacksmith","Obtain 20 Pierres de Diamond","Return to Blacksmith","Après 24h, récupérez the Whale Harpooner auprès of the Blacksmith","Bring them to the Fisherman"]},{"niv":43,"nom":"Allez voir Wonda-Rim","pnj":"Wonda-Rim","recompenses":"1.250.000 EXP · 32.000 Yang","processus":["Talk to Wonda-Rim","Talk to Chaegirab","Kill Combattants orcs until you get the Letter","Return to Wonda-Rim"]},{"niv":44,"nom":"La carte au trésor de Soon","pnj":"Soon","recompenses":"1.400.000 EXP · 25.000 Yang · Casque 41 selon the classe","processus":["Talk to Soon","Kill Bera, Lykos, Tigris and Scrofa until you get the 4 Treasure Maps","Return to talk to Soon","Talk to the Vieil homme qui vous donne a Treasure Chest","Return to talk to Soon"]},{"niv":45,"nom":"Le trésor du chasseur","pnj":"Yang-Shin","recompenses":"1.500.000 EXP · 35.000 Yang · 20× Bravery Cape","processus":["Talk to Yang-Shin","Kill the singes in the Monkey Dungeon (Sangsun Dong) until you get the Crafted Bow","Return to talk to Yang-Shin"]},{"niv":46,"nom":"Laissez les morts reposer en paix","pnj":"Dragon Master","recompenses":"1.700.000 EXP · 30.000 Yang · 3× Diamond","processus":["Talk to the Dragon Master","Kill Proud Deadly Chiefs until you get the Temple Scarf and the Temple Doctrine","Return to talk to the Dragon Master"]},{"niv":47,"nom":"L'étable a des ennuis","pnj":"Yonah","recompenses":"1.800.000 EXP · Difficult Quest Book","processus":["Talk to Yonah","Obtain 10 Hay","Talk to the Stablehand","Return to talk to Yonah"]},{"niv":47,"nom":"Les pages du livre secret 5 (suite, niv. 47)","pnj":"Automatic","recompenses":"2.000.000 EXP · 50.000 Yang","processus":["Give to Uriel the page obtenue sur the Captain bestial (quête commencée at level 40)"]},{"niv":47,"nom":"Les pages du livre secret 6","pnj":"Automatic","recompenses":"3.000.000 EXP · 75.000 Yang · Dragon Blessing","processus":["Talk to Uriel","Go see the Monument Mok au fond of the Kuahlo Dong","Return to talk to Uriel"]},{"niv":47,"nom":"Les pages du livre secret 7","pnj":"Automatic","recompenses":"3.000.000 EXP · 75.000 Yang","processus":["Talk to Yu-Hwan","Kill Hors the loi of the Désert until you get the Diary Page","Talk to Yu-Hwan","Talk to Uriel"]},{"niv":47,"nom":"Les pages du livre secret 8","pnj":"Automatic","recompenses":"3.000.000 EXP · 70.000 Yang · 20× Bravery Cape","processus":["Talk to Uriel","Kill Snake Swordsmen and Snake Archers until you get the Diary Page","Talk to Uriel"]},{"niv":48,"nom":"Un médicament pour Balso","pnj":"Balso the Traitor","recompenses":"1.900.000 EXP · 30.000 Yang","processus":["Go see Balso the Traitor","Kill Plagueiférés until you get Plaguee","Return it to Balso the Traitor"]},{"niv":49,"nom":"Œil d'araignée spéciaux","pnj":"Octavio","recompenses":"2.100.000 EXP · 20.000 Yang","processus":["Go see Octavio","Collect 100× Œil d'araignée sur the araignées of the Désert de Yongbi","Bring them back to Octavio"]},{"niv":50,"nom":"Les pages du livre secret 9","pnj":"Uriel","recompenses":"5.000.000 EXP · 125.000 Yang · Wise King Symbol","processus":["Kill Elite Spider Soldiers at Kuahlo Dong until you get the Diary Page","Bring it to Uriel"]},{"niv":50,"nom":"Les pages du livre secret 10","pnj":"Automatic","recompenses":"5.500.000 EXP · 137.500 Yang · Wise King Gloves","processus":["Go to the Mont Sohan","Find the Diary Page dans the Old Paper Box","Bring back the page to Uriel"]},{"niv":50,"nom":"Les pages du livre secret 11","pnj":"Automatic","recompenses":"6.000.000 EXP · 150.000 Yang · Dragon Medal","processus":["Kill Claw Spiders at Kuahlo Dong until you get the Diary Page","Rapportez-la to Uriel"]},{"niv":50,"nom":"Le code","pnj":"Captain","recompenses":"1.300.000 EXP · 20.000 Yang","processus":["Talk to the Captain","Solve the proposed anagram"]},{"niv":51,"nom":"Le secret de la porcelaine céladon","pnj":"Yonah","recompenses":"2.500.000 EXP · 35.000 Yang · Jade Shoes +3","processus":["Talk to Yonah","Talk to Uriel","Talk to Soon","Talk to the Traveling Merchant","Return to Soon","Return to Yonah"]},{"niv":52,"nom":"Une bonne nuit de sommeil","pnj":"Captain","recompenses":"3.800.000 EXP · 270.000 Yang · Manual (class based)","processus":["Talk to the Captain","Talk to Baek-Go","Talk to Yu-Hwan","Return to talk to the Captain","Vengez the soldats en tuant Deadly Executioners, Deadly Summoners, Hauts tourmenteurs and Hauts évocateurs","Return to talk to the Captain"]},{"niv":53,"nom":"La porcelaine vert pâle","pnj":"Yonah","recompenses":"3.000.000 EXP · 30.000 Yang","processus":["Talk to Yonah","Kill Hors the loi of the Désert to get the Desert Sand","Obtain of the Crystal Ore","Kill Strong Stone Monkeys and Strong Gold Monkeys to get the Primate Blood","Bring the tout to Yonah"]},{"niv":54,"nom":"Les provisions","pnj":"Captain","recompenses":"3.750.000 EXP · 125.000 Yang · Tiger Monkey Shield +3","processus":["Talk to the Captain","Talk to the Merchant Lady","Talk to the Captain","Talk to Yang-Shin","Kill Cursed White Tigers until you get 20 Brilliant Tiger Furs","Return to talk to Yang-Shin"]},{"niv":55,"nom":"Les pages du livre secret 12","pnj":"Automatic","recompenses":"7.500.000 EXP · 162.500 Yang","processus":["Chunjo → Monument of Weol à Pyungmoo | Jinno → Monument of Weol à Yongan | Shinsoo → Monument of Weol à Joan","Talk to Uriel"]},{"niv":55,"nom":"Les pages du livre secret 13","pnj":"Automatic","recompenses":"14.500.000 EXP · 175.000 Yang · Chief's Book","processus":["Kill Scarecrows jusqu'au changement de the quête","Go to the Monument Gum at Hwang Temple","Talk to Uriel"]},{"niv":55,"nom":"La situation de Balso","pnj":"Balso the Traitor","recompenses":"4.000.000 EXP · 65.000 Yang","processus":["Talk to Balso the Traitor","Talk to Baek-Go","Kill the Monkey Lord until you get the Herbe of the donjon difficile","Bring it to Baek-Go to get the Médicaments","Bring the Médicaments to Balso the Traitor"]},{"niv":56,"nom":"Soutien de dispositif de guerre","pnj":"Captain","recompenses":"4.500.000 EXP · 50.000 Yang · 3× Attaque perçante · 3× Attaque critique","processus":["Talk to the Captain","Kill Archers pestiférés until you get 5.000 Hauts de flèches","Return to talk to the Captain"]},{"niv":57,"nom":"Trouvez des pattes de grenouilles","pnj":"Storekeeper","recompenses":"5.000.000 EXP · 50.000 Yang","processus":["Talk to the Storekeeper","Talk to Octavio","Kill Chefs gren. arboricoles until you get the Pattes de grenouille (quête)","Return to talk to Octavio"]},{"niv":58,"nom":"Rencontrez l'espion","pnj":"Captain","recompenses":"5.500.000 EXP · 50.000 Yang · 3× Gardon rouge","processus":["Talk to the Captain","Chunjo → Fisherman à Yongan | Jinno → Fisherman à Joan | Shinsoo → Fisherman à Pyungmoo","Return to talk to the Captain"]},{"niv":59,"nom":"Bingsu?","pnj":"Taurean","recompenses":"6.000.000 EXP · 70.000 Yang · War Scroll","processus":["Talk to Taurean","Talk to Harang","Talk to Octavio","Kill Glaces enchantées until you get 50 Ice Cubes","Échangez the Ice Cubes to Octavio contre the Shaved Ice","Return to talk to Taurean"]},{"niv":60,"nom":"Temple obscur","pnj":"Soon","recompenses":"7.000.000 EXP · 70.000 Yang · Chief's Book (2h)","processus":["Talk to Soon","Kill Elite Esoteric Summoners until you get the Temple Scarf, the Temple Doctrine and the Translation of the Cursed Book","Return to talk to Soon"]},{"niv":60,"nom":"Nation obscure I","pnj":"Uriel","recompenses":"12.000.000 EXP · 175.000 Yang · 10× Exorcism Scroll · 10× Fleur de pêcher · 10× Lilas","processus":["Talk to Uriel","Obtain the Epitaph Copy sur the Ancient Tombstone","Return to talk to Uriel"]},{"niv":60,"nom":"Nation obscure II","pnj":"Uriel","recompenses":"9.700.000 EXP · 3× Concentrated Reading · Toile d'araignée · Glande venin d'araignée","processus":["Talk to Uriel","Kill Arbres maléfiques until you get the Ancient Document","Return to talk to Uriel","Kill à nouveau Arbres maléfiques until you get the 9 autres Documents anciens","Return to talk to Uriel"]},{"niv":66,"nom":"Le journal","pnj":"Uriel","recompenses":"9.500.000 EXP · 3× Blessing Scroll · Scorpion Tail","processus":["Talk to Uriel","Kill the Demon King in the Demon Tower (Tower of Gumsan)","Return to talk to Uriel"]},{"niv":66,"nom":"Lettre anonyme","pnj":"Village Guardian","recompenses":"< 30 min : 4.500.000 EXP · 200.000 Yang · Porcelaine brisée + roses + baies | Sinon : 4.000.000 EXP · 100.000 Yang + roses + baies","processus":["Talk to the Village Guardian","Talk to Lee Chung","Kill 200 Dryades rouges, obtenez the Antidote and apportez-le to Lee Chung in less than 30 minutes","Talk to the Soldat empoisonné","Talk to Lee Chung"]},{"niv":72,"nom":"La découverte","pnj":"Lee Chung","recompenses":"12.350.000 EXP · EXP Ring (1h) · Fabric Piece · Médicament inconnu ou Médicament inconnu+","processus":["Talk to Lee Chung","Go to the Crumbling Stone at the Red Wood to get the Notes","Return to talk to Lee Chung"]},{"niv":72,"nom":"Trésor glacé","pnj":"Lee Chung","recompenses":"40.000.000 EXP · 225.000 Yang · 3× Researcher's Elixir · Thief's Gloves (2h) · Luck Medal","processus":["Talk to Lee Chung","Kill Golems de glace, Yétis and Hommes de glace furieux until you get Essences de cristal bleu","Bring 50 Essences de cristal bleu to Lee Chung (may fail)"]},{"niv":75,"nom":"Dans la grotte","pnj":"Seon-Hae","recompenses":"Blood Stone","processus":["Talk to Seon-Hae","Go to Doyyumhwan — recherchez 7 Petrified Tears aux points indiqués","Kill Flammes until you get 4 Obsidiennes","Bring the tout to Seon-Hae — you receive the Tears of Baljit-Elvedin","Go to the point indiqué at the Red Wood","Cliquez sur the parchemin de quête to get the Blood Drop","Bring the Blood Drop to Seon-Hae pour recevoir the Blood Stone"]},{"niv":75,"nom":"Journal intime d'une légende","pnj":"Heuk-Young","recompenses":"89.000.000 EXP · 1.200.000 Yang · Legendary Journal","processus":["Talk to Heuk-Young","Obtain 12 Pages sur the Sura Skeletons 1, 2, 3, 4 (Grotte de the Exil) and Squelette de Sura 5 (Grotte de the Exil 2)","Kill Golems de glace d'enfer until you get 6 Pages supplémentaires","Bring the 15 Pages to Heuk-Young"]},{"niv":78,"nom":"Quartz de l'enfer rouge","pnj":"Lee Chung","recompenses":"36.000.000 EXP · Sun Elixir (m) · Blessing Orb · Attention Medal (4h)","processus":["Talk to Lee Chung","Kill Tigres de combat, Flammes and Guerriers flamme to get Terre volcanique, Crinières flamboyantes and Pierres de fondation","Bring a fois chaque objet to Lee Chung pour tenter the création d'un Quartz de the enfer rouge","Return 20 Quartz de the enfer rouge to Lee Chung"]},{"niv":78,"nom":"Dernier élément","pnj":"Lee Chung","recompenses":"48.000.000 EXP · 230.000 Yang · Moon Elixir (m) · Magic Copper · Chief's Book (2h) · 2× Tête réduite (via Baek-Go)","processus":["Talk to Lee Chung","Kill Arbres maléfiques rouges until you get 100 Sacred Tree Resin","Return to talk to Lee Chung","Talk to Baek-Go"]},{"niv":80,"nom":"Le Sombre Masque de Bois","pnj":"Soon","recompenses":"120M EXP + 3M Yang OR 70M EXP + 7× Dragon Medal OR 120M EXP + pack objets of the dieu dragon","processus":["Talk to Soon","Kill Esprits flammes jusqu'à ce que the Dark Wooden Mask transforms into Enchanted Ashes","Kill Yétis until you get 10 Ice Cubes","Return to talk to Soon","Go to the Dark Altar at the Exile Cave avec the Black Ice","Return to talk to Soon"]},{"niv":80,"nom":"Monstre étrange","pnj":"Soon","recompenses":"—","processus":["Arrow on Soon — quest automatically triggered après Le Dark Wooden Mask"]},{"niv":84,"nom":"La bataille commence","pnj":"Lee Chung","recompenses":"63.000.000 EXP · 250.000 Yang · Wise King Gloves · Wise King Symbol · Magic Iron Ore","processus":["Talk to Lee Chung","Vous recevez the Larme of the ciel de Lee Chung","Kill Tartaros"]},{"niv":84,"nom":"Prince Charon","pnj":"Automatic","recompenses":"84.000.000 EXP · 250.000 Yang · 2× Blacksmith's Stone · 20× Bravery Cape · Life Fruit","processus":["Kill Charon"]},{"niv":90,"nom":"La mission de Lee Chung","pnj":"Lee Chung","recompenses":"50.000 Yang","processus":["Talk to Lee Chung","Talk to the Teleporter","Téléportez-vous à Cap Feu of the Dragon"]},{"niv":90,"nom":"Rocher du Dragon Sombre","pnj":"Admiral Angmur","recompenses":"100.000 Yang","processus":["Talk to the Amiral Angmur","Atteignez the 3 points présents sur the carte","Return to talk to the Amiral Angmur"]},{"niv":90,"nom":"La Lettre de Lee Chung","pnj":"Admiral Angmur","recompenses":"6.247.460 EXP · 137.000 Yang · 10× Lilas","processus":["Talk to the Amiral Angmur","Kill Gnoll Warriors, Gnoll Archers, Gnoll Defenders, Gnoll Mages, Gnoll Generals ou the Supreme Gnoll Guard until you get the Letter de Lee Chung","Return to talk to the Amiral Angmur"]},{"niv":90,"nom":"La lettre gnolle I","pnj":"Admiral Angmur","recompenses":"15.630.000 EXP · 148.000 Yang · EXP Ring (1h) · Scorpion Tail","processus":["Talk to the Amiral Angmur","Kill the Gnoll General until you get the Letter Gnoll","Return to talk to the Amiral Angmur"]},{"niv":90,"nom":"La lettre gnolle II","pnj":"Admiral Angmur","recompenses":"23.130.000 EXP · 100.000 Yang · Morceau de gemme · 10× Baie","processus":["Talk to the Amiral Angmur","Kill the Gnoll Lord until you get the 2ème Letter Gnoll","Return to talk to the Amiral Angmur"]},{"niv":90,"nom":"La Manticore","pnj":"Admiral Angmur","recompenses":"12.933.700 EXP · 170.000 Yang · Peau de tigre blanc","processus":["Talk to the Amiral Angmur","Kill 50× Manticore Warriors · 40× Manticore Soldiers · 20× Manticore Executioners · 10× Core Generals","Return to talk to the Amiral Angmur"]},{"niv":90,"nom":"Renforcer le mur de protection I","pnj":"Admiral Angmur","recompenses":"21.640.000 EXP · Molaire d'orc · 5× Rose montagnes","processus":["Talk to the Amiral Angmur","Kill Gnoll Warriors, Gnoll Archers, Gnoll Defenders, Gnoll Mages, Gnoll Generals, Seigneurs gnoll and Supreme Gnoll Guards until you get 50 Sables fins","Return to talk to the Amiral Angmur"]},{"niv":90,"nom":"Renforcer le mur de protection II","pnj":"Admiral Angmur","recompenses":"22.380.000 EXP · 192.000 Yang · Thief's Gloves (2h) · 2× Souvenir de Démon","processus":["Talk to the Amiral Angmur","Kill Manticore Warriors, Manticore Soldiers, Manticore Mages, Manticore Executioners, Core Generals, Rakshasas and Martyaxwars until you get 100 Briques","Return to talk to the Amiral Angmur"]},{"niv":91,"nom":"La lettre manticore","pnj":"Admiral Angmur","recompenses":"18.803.000 EXP · Talisman inconnu · 10× Eau de Dok","processus":["Talk to the Amiral Angmur","Kill Core Generals until a fenêtre s'ouvre vous informant qu'il a remis the lettre","Return to talk to the Amiral Angmur"]},{"niv":91,"nom":"Le repaire de Martyaxwar","pnj":"Admiral Angmur","recompenses":"37.310.000 EXP · Third Hand · 20× Campanule","processus":["Talk to the Amiral Angmur","Kill Martyaxwar until you get the Collier à clous","Return to talk to the Amiral Angmur"]},{"niv":91,"nom":"Décodage","pnj":"Yon-I-Walker","recompenses":"25.805.400 EXP · 214.000 Yang · 2× Médicament inconnu","processus":["L'Amiral Angmur vous enverra parler to Yon-I-Walker","Kill Crab Warriors, Scorpion Archers, Shrimp Soldiers, Diabolic Hermits and Armored Crabs to get Tablettes carapax","Submit 10 auprès de Yon-I-Walker (may fail)"]},{"niv":91,"nom":"Lettre de Manticore décodée","pnj":"Yon-I-Walker","recompenses":"27.874.000 EXP · 225.000 Yang","processus":["Talk to Yon-I-Walker","Kill the Lobster General and the Roi crabes to get Poudres de carapax","Turn in 3 to Yon-I-Walker (24h d'attente entre chaque poudre, may fail)"]},{"niv":91,"nom":"Empoisonné !","pnj":"Admiral Angmur","recompenses":"6.766.050 EXP · 2× Dard de scorpion","processus":["Talk to the Amiral Angmur","Go to the Fleur de rocher and obtain the Rock Flower Root","Talk to Yon-I-Walker"]},{"niv":92,"nom":"La lettre du voleur rouge","pnj":"Admiral Angmur","recompenses":"33.874.000 EXP · 200.000 Yang · 10× Eau de Zin","processus":["Talk to the Amiral Angmur","Kill the Red Thief Executioner and the Black General until you get 4 Letters of the voleur rouge","Return to talk to the Amiral Angmur"]},{"niv":92,"nom":"La lettre du voleur rouge 2","pnj":"Admiral Angmur","recompenses":"20.874.600 EXP · 2× Livre maléfique","processus":["Talk to the Amiral Angmur","Find the Soldat blessé at Nephrite Bay and obtain the 5ème Letter of the voleur rouge","Return to talk to the Amiral Angmur"]},{"niv":92,"nom":"Décoder la lettre du voleur rouge","pnj":"Yon-I-Walker","recompenses":"52.310.000 EXP · 2× White Pearl","processus":["Talk to the Amiral Angmur","Talk to Yon-I-Walker","Kill the Kappa General and Triton to get 10 Oin Scales","Return to talk to Yon-I-Walker"]},{"niv":92,"nom":"Sombres projets","pnj":"Admiral Angmur","recompenses":"24.911.300 EXP · 2× Blue Pearl","processus":["Talk to the Amiral Angmur"]},{"niv":93,"nom":"Prendre des forces I","pnj":"Admiral Angmur","recompenses":"41.810.000 EXP · 2× Blood Pearl","processus":["Talk to the Amiral Angmur","Talk to Yon-I-Walker","Kill Polyphemus until you get Inner Light","Return to talk to Yon-I-Walker"]},{"niv":93,"nom":"Prendre des forces II","pnj":"Yon-I-Walker","recompenses":"43.370.000 EXP · 302.000 Yang · Ice Fragment · 10× Eau de Mong","processus":["Talk to Yon-I-Walker","Kill the Roi Wobba until you get Inner Light","Return to talk to Yon-I-Walker"]},{"niv":93,"nom":"Prendre des forces III","pnj":"Yon-I-Walker","recompenses":"17.904.600 EXP · 30.000 Yang · Concentrated Reading · Luck Medal","processus":["Talk to Yon-I-Walker","Talk to Octavio","Wait 24 hours"]},{"niv":93,"nom":"La recette du Millénaire","pnj":"Octavio","recompenses":"31.374.000 EXP · 5× Blessing Scroll · 20× Champignon Tue","processus":["Talk to Octavio","Collect 200× Racine de gango · 200× Champignon Tue · 200× Rose montagnes","Talk to Octavio","Wait 24 hours"]},{"niv":93,"nom":"Essence du Millénaire","pnj":"Octavio","recompenses":"19.920.800 EXP · 335.000 Yang · 20× Sun Elixir (s) · Wise King Symbol","processus":["Talk to Octavio","Collect the Millennium Essence","Return to talk to Yon-I-Walker"]},{"niv":94,"nom":"Perle de Léviathan","pnj":"Yon-I-Walker","recompenses":"12.904.600 EXP · 346.000 Yang · 3× Exorcism Scroll","processus":["Talk to Yon-I-Walker","Receive the Leviathan Pearl","Use it","Return to talk to the Amiral Angmur"]},{"niv":94,"nom":"Appel de la Montagne de Tonnerre","pnj":"Admiral Angmur","recompenses":"14.074.700 EXP · 357.000 Yang · 3× Porcelaine brisée","processus":["Talk to the Amiral Angmur","Explorez the Montagne de Tonnerre en vérifiant the points présents sur the carte","Return to talk to the Amiral Angmur"]},{"niv":94,"nom":"Affaiblissez les Voleurs Rouges","pnj":"Admiral Angmur","recompenses":"16.014.000 EXP · Blessing Orb · 3× Fabric Piece · 20× Eau de Hwal","processus":["Talk to the Amiral Angmur","Kill Brutal Red Chiefs until you get Chief Cape","Return to talk to the Amiral Angmur"]},{"niv":94,"nom":"Affaiblissez le Cyclope","pnj":"Admiral Angmur","recompenses":"21.014.000 EXP · 379.000 Yang · Magic Copper · Chief's Book (2h)","processus":["Talk to the Amiral Angmur","Kill 30× General Outis · 3× Argès · 1× Polyphemus","Return to talk to the Amiral Angmur"]},{"niv":94,"nom":"Affaiblissez les Géants","pnj":"Admiral Angmur","recompenses":"37.550.000 EXP · 390.000 Yang · Magic Iron Ore · 2× Blacksmith's Stone · 5× Haricot Zen · 10× Rosée blanche","processus":["Talk to the Amiral Angmur","Kill the Roi Wobba until you get 9× Giant Totem","Return to talk to the Amiral Angmur"]},{"niv":94,"nom":"Aux Montagnes de Tonnerre","pnj":"Admiral Angmur","recompenses":"11.355.698 EXP · Blessing Orb","processus":["Talk to the Amiral Angmur","Kill One-Eye Breakers, Cyclops Soldiers, Cyclops Mages, Cyclops Executioners, Généraux Outis, Argès and Polyphemus until you get the Black Stone and the Page of the journal","Return to talk to the Amiral Angmur"]},{"niv":94,"nom":"Or Noire","pnj":"Admiral Angmur","recompenses":"26.473.000 EXP · 5× Exorcism Scroll","processus":["Talk to the Amiral Angmur","Talk to the Alchemist","Kill One-Eye Breakers, Cyclops Soldiers, Cyclops Mages, Cyclops Executioners, Généraux Outis, Argès and Polyphemus until you get 30× Black Gold","Give 10× Black Gold to the Alchemist (may fail)","Return to talk to the Amiral Angmur"]},{"niv":95,"nom":"Fièvre de l'or","pnj":"Admiral Angmur","recompenses":"27.532.400 EXP · 302.000 Yang · Blood Pearl","processus":["Talk to the Amiral Angmur","Kill Captains Crochet until you get the Letter of the Captain Crochet","Return to talk to the Amiral Angmur"]},{"niv":95,"nom":"Détournez la Livraison","pnj":"Admiral Angmur","recompenses":"43.550.000 EXP · Ice Fragment","processus":["Talk to the Amiral Angmur","Kill Captains Shrouk until you get the Shrouk Leather","Return to talk to the Amiral Angmur"]},{"niv":95,"nom":"Arrêtez le Traitement","pnj":"Admiral Angmur","recompenses":"33.003.900 EXP · Luck Medal · Concentrated Reading","processus":["Talk to the Amiral Angmur","Kill Le gros ogre","Return to talk to the Amiral Angmur"]},{"niv":95,"nom":"Malédiction de Vie","pnj":"Admiral Angmur","recompenses":"30.943.600 EXP · 335.000 Yang · 5× Blessing Scroll","processus":["Talk to the Amiral Angmur","Kill Lemure Mages until you get the Lemure Tablet","Return to talk to the Amiral Angmur"]},{"niv":95,"nom":"L'inscription","pnj":"Admiral Angmur","recompenses":"31.932.500 EXP · 337.000 Yang · Sun Elixir (s) · Wise King Symbol","processus":["Talk to the Amiral Angmur","Kill Lemure Mages until you get the 2 Tablettes lémures manquantes","Return to talk to the Amiral Angmur"]},{"niv":95,"nom":"Chaos dans la Forêt Enchantée","pnj":"Temple Guardian","recompenses":"5.825.000 EXP · 5× Rose montagnes","processus":["Talk to the Village Guardian — il gives you a Esprit de the terre","Enter the Temple Ochao and tuez the Gardien En-Tai","Pass through the Portal created by sa mort pour parvenir at the Enchanted Forest","Talk to the Gardien de the forêt in order to lui remettre the Esprit de the terre"]},{"niv":95,"nom":"Première exploration","pnj":"Forest Guardian","recompenses":"776.600 EXP (repeatable)","processus":["Talk to the Gardien de the forêt","Kill 50 En-Tai Warriors","Return to Gardien de the forêt"]},{"niv":95,"nom":"Cherchez la Trousse de secours","pnj":"Forest Guardian","recompenses":"776.600 EXP (repeatable)","processus":["Talk to the Gardien de the forêt","Kill En-Tai Druids until you get a Trousse de secours","Return to Gardien de the forêt"]},{"niv":95,"nom":"Remettre la Trousse de secours","pnj":"Forest Guardian","recompenses":"5.825.000 EXP · 10× Racine de gango (repeatable)","processus":["Talk to the Gardien de the forêt","Bring the Trousse de secours jusqu'au Guetteur de the forêt"]},{"niv":95,"nom":"Seconde exploration","pnj":"Forest Watcher","recompenses":"7.766.000 EXP (repeatable)","processus":["Talk to the Guetteur de the forêt","Destroy 5 Metins êtres sylv.","Return to Guetteur de the forêt"]},{"niv":95,"nom":"Récupérer la Rosée En-Tai","pnj":"Forest Watcher","recompenses":"7.766.000 EXP · 10× Eau de Yuong (repeatable)","processus":["Talk to the Guetteur de the forêt","Kill En-Tai Destroyers until you get 5× Rosée En-Tai","Bring them au Guetteur de the forêt"]},{"niv":95,"nom":"Tuez le Seigneur En-Tai","pnj":"Forest Scout","recompenses":"11.650.000 EXP (repeatable)","processus":["Talk to the Éclaireur de the forêt","Kill the Seigneur En-Tai until you get the Bois précieux","Return to the Éclaireur de the forêt"]},{"niv":95,"nom":"Trouvez une Émeraude boisée","pnj":"Forest Scout","recompenses":"11.650.000 EXP · Pierre Dryades (repeatable)","processus":["Talk to the Éclaireur de the forêt","Kill the Seigneur En-Tai until you get the Émeraude boisée","Return to the Éclaireur de the forêt"]}];
...
function initQuestRows() {
  ...
  /* Index JSON par nom normalisé (FR) */
  const idx = {};
  const idxByPos = QUESTS_DATA.filter(q => q.niv <= 84);
  idxByPos.forEach(q => { idx[normalize(q.nom)] = q; });

  /* Pour EN : correspondance par position dans chaque tableau */
  const isENPage = document.documentElement.lang === 'en';
  /* EN: utiliser QUESTS_DATA_EN si disponible */
  const sourceData = (isENPage && typeof QUESTS_DATA_EN !== 'undefined') ? QUESTS_DATA_EN : idxByPos;
  const sourceIdx  = {};
  sourceData.forEach(q => { sourceIdx[normalize(q.nom)] = q; });
  ...
  panel.querySelectorAll('.qt tbody tr').forEach(tr => {
    ...
    let data;
    if (isENPage) {
      data = sourceData[posCounter];
      posCounter++;
    } else {
      data = sourceIdx[normalize(cells[1]?.textContent?.trim())];
    }
    if (!data) return;
